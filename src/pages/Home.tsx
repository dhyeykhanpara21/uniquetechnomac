...
export default function Home() {
  ...
  // Split gallery items into two distinct rows of 8 unique photos for scrolling
  const firstRowItems = GALLERY.slice(0, 8);
  const secondRowItems = GALLERY.slice(8, 16);
