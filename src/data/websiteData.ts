...
export const HERO_SLIDES = [
  {
    id: 'slide-1',
    image: oilSealKit1,
    detailImage: oilSealKit2,
    title: 'Hand Pallet Truck Oil Seal Kit',
    subtitle: 'PREMIUM SEAL KITS',
    description: 'High-quality oil seal kits and parts for hand pallet trucks, ensuring leak-proof hydraulic performance.',
  ...
  },
  {
    ...
    detailImage: oilSealKitPart2,
    title: 'Oil Seal Kit Parts',
    subtitle: 'PRECISION ENGINEERED',
    description: 'Durable replacement parts for hand pallet truck oil seal kits, designed for exact fit and long life.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Seal Kit Parts',
    badgeIcon: 'ShieldAlert',
    tabLabel: 'Seal Kit Parts'
  },
  {
    id: 'slide-3',
    image: pressureShaft1,
    detailImage: pressureShaft3,
    title: 'Pressure Shaft 12MM 15MM',
    subtitle: 'HIGH-STRENGTH SHAFTS',
    description: 'Robust pressure shafts designed for optimal performance in hand pallet truck hydraulic systems.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Pressure Shafts',
    badgeIcon: 'Settings2',
    tabLabel: 'Pressure Shafts'
  },
  {
    id: 'slide-4',
    image: handPalletPump1,
    detailImage: handPalletPump2,
    title: 'Hand Pallet Truck Pump',
    subtitle: 'RELIABLE HYDRAULICS',
    description: 'Premium quality hydraulic pumps ensuring smooth and efficient lifting operations.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Pumps',
    badgeIcon: 'Settings2',
  ...
  },
  {
    id: 'slide-5',
    image: pistonBush1,
    detailImage: pistonBush2,
    title: 'Piston Bush Pallet Truck Part',
    subtitle: 'PRECISION BUSHINGS',
    description: 'High-precision piston bushes for minimal friction and maximum longevity in pallet trucks.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Piston Bushes',
    badgeIcon: 'Settings2',
    tabLabel: 'Bushes'
  },
  {
    id: 'slide-6',
    image: palletPin1,
    detailImage: palletPin2,
    title: 'Hand Pallet Spares Part Pin 16 x 85',
    subtitle: 'DURABLE PINS',
    description: 'Heavy-duty steel pins engineered to withstand high stress and wear in pallet truck assemblies.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Pins',
    badgeIcon: 'Settings2',
  ...
  },
  {
    id: 'slide-7',
    image: pumpPiston1,
    detailImage: pumpPiston2,
    title: 'Pump Piston Hand Pallet 18 x 100',
    subtitle: 'OPTIMAL PRESSURE',
    description: 'Precision-machined pump pistons ensuring consistent hydraulic pressure and performance.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Pump Pistons',
    badgeIcon: 'Settings2',
    tabLabel: 'Pistons'
  },
  {
    ...
    detailImage: rollerLinkingShaft2,
    title: 'Roller Linking Shaft 20 x 95',
    subtitle: 'STURDY LINKAGES',
    description: 'High-strength roller linking shafts for reliable connection and movement in hand pallet trucks.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Linking Shafts',
    badgeIcon: 'Settings2',
    tabLabel: 'Shafts'
  },
  {
    ...
    detailImage: palletPin20x105_2,
    title: 'Hand Pallet Truck Pin 20 x 105',
    subtitle: 'HEAVY-DUTY PINS',
    description: 'Premium quality 20x105 pins designed for secure assembly and long-lasting durability.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Pins',
    badgeIcon: 'Settings2',
  ...
  },
  {
    ...
    detailImage: palletPin16x155_2,
    title: 'Hand Pallet Spares Part Pin 16 x 155',
    subtitle: 'PRECISION PINS',
    description: 'Durable and precisely dimensioned 16x155 pins for structural integrity of pallet trucks.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Pins',
    badgeIcon: 'Settings2',
  ...
  },
  {
    ...
    detailImage: rollerLinkingPlate2,
    title: 'Roller Linking Plate',
    subtitle: 'ROBUST PLATES',
    description: 'Heavy-duty roller linking plates ensuring stable load distribution and smooth roller operation.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Linking Plates',
    badgeIcon: 'ShieldAlert',
    tabLabel: 'Plates'
  },
  {
    ...
    detailImage: paddlePinShaft2,
    title: 'Paddle Pin Shaft',
    subtitle: 'RELIABLE SHAFTS',
    description: 'High-quality paddle pin shafts engineered for consistent performance and wear resistance.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Pin Shafts',
    badgeIcon: 'Settings2',
    tabLabel: 'Shafts'
  },
  {
    id: 'slide-13',
    image: ppcpWheel1,
    detailImage: ppcpWheel2,
    title: 'PPCP Wheel 180 X 50',
    subtitle: 'DURABLE WHEELS',
    description: 'Tough PPCP wheels providing excellent load-bearing capacity and smooth movement.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'PPCP Wheels',
    badgeIcon: 'Settings2',
    tabLabel: 'Wheels'
  },
  {
    ...
    detailImage: handPalletBracket2,
    title: 'Hand Pallet Truck Bracket',
    subtitle: 'STURDY BRACKETS',
    description: 'Robust brackets providing structural support and secure mounting for pallet truck components.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Brackets',
    badgeIcon: 'ShieldAlert',
  ...
  },
  {
    ...
    detailImage: handPalletSpring2,
    title: 'Stainless Steel Hand Pallet Spring',
    subtitle: 'HIGH TENSION SPRINGS',
    description: 'Corrosion-resistant stainless steel springs delivering reliable tension and return action.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Springs',
    badgeIcon: 'Settings2',
  ...
  },
  {
    ...
    detailImage: handPalletWheelBracket2,
    title: 'Hand Pallet Wheel Brackets',
    subtitle: 'HEAVY-DUTY WHEEL MOUNTS',
    description: 'Durable wheel brackets ensuring secure wheel attachment and stable load handling.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Wheel Brackets',
    badgeIcon: 'ShieldAlert',
    tabLabel: 'Brackets'
  },
  {
    ...
    detailImage: rollerBracketHpt2,
    title: 'Roller Bracket HPT',
    subtitle: 'PRECISION BRACKETS',
    description: 'High-quality roller brackets engineered for precise alignment and smooth roller function.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Roller Brackets',
    badgeIcon: 'Settings2',
    tabLabel: 'Brackets'
  },
  {
    id: 'slide-18',
    image: mainShaft1,
    detailImage: mainShaft2,
    title: 'Main Shaft 35 x 285',
    subtitle: 'CORE STRUCTURAL SHAFTS',
    description: 'Heavy-duty main shafts providing essential structural integrity for hand pallet trucks.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Main Shafts',
    badgeIcon: 'Settings2',
    tabLabel: 'Shafts'
  },
  {
    id: 'slide-19',
    image: leverPlate1,
    detailImage: leverPlate2,
    title: 'Hand Pallet Lever Plates',
    subtitle: 'DURABLE LEVER MECHANISMS',
    description: 'Sturdy lever plates designed for reliable control and operation of pallet truck mechanisms.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Lever Plates',
    badgeIcon: 'Settings2',
    tabLabel: 'Plates'
  },
  {
    ...
    detailImage: handPalletPin16x41_2,
    title: 'Hand Pallet Spares Part Pin 16 x 41',
    subtitle: 'COMPACT PINS',
    description: 'High-strength 16x41 pins ensuring secure linkages in confined spaces of pallet trucks.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Pins',
    badgeIcon: 'Settings2',
  ...
  },
  {
    ...
    detailImage: handPalletPin25x176_2,
    title: 'Hand Pallet Spares Part Pin 25 x 176',
    subtitle: 'LARGE LOAD PINS',
    description: 'Heavy-duty 25x176 pins designed to handle significant stress and loads.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Pins',
    badgeIcon: 'Settings2',
  ...
  },
  {
    ...
    detailImage: heavyDutyPalletTruck2,
    title: 'Heavy Duty Hand Pallet Truck',
    subtitle: 'ROBUST MATERIAL HANDLING',
    description: 'Complete heavy-duty pallet trucks engineered for demanding industrial environments.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Pallet Trucks',
    badgeIcon: 'ShieldAlert',
    tabLabel: 'Trucks'
  },
  {
    ...
    detailImage: nylonWheel70x80_2,
    title: 'Nylon Wheel 70x80',
    subtitle: 'WEAR-RESISTANT WHEELS',
    description: 'Durable nylon wheels providing low rolling resistance and high load capacity.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Nylon Wheels',
    badgeIcon: 'Settings2',
    tabLabel: 'Wheels'
  },
  {
    ...
    detailImage: puPalletWheel2,
    title: 'PU Hand Pallet Truck Wheels',
    subtitle: 'SMOOTH OPERATION',
    description: 'Premium PU wheels ensuring floor protection and quiet, smooth movement.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'PU Wheels',
    badgeIcon: 'Settings2',
  ...
  },
  {
    ...
    detailImage: rollerBracketNylonWheel2,
    title: 'Roller Bracket Set Nylon Wheel',
    subtitle: 'COMPLETE BRACKET SETS',
    description: 'Integrated roller bracket sets with nylon wheels for easy installation and reliable performance.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'Nylon Brackets',
    badgeIcon: 'Settings2',
    tabLabel: 'Brackets'
  },
  {
    ...
    detailImage: rollerBracketPuWheel2,
    title: 'Roller Bracket Set PU Wheel',
    subtitle: 'PREMIUM BRACKET SETS',
    description: 'High-quality roller bracket sets featuring PU wheels for superior durability and floor care.',
    ctaText: 'View Details',
    ctaLink: '/products',
    badgeText: 'PU Brackets',
    badgeIcon: 'Settings2',
    tabLabel: 'Brackets'
  }
];
